...
class Utf8ParserTest extends TestCase {
	...
	public function successfulConversions() {
		return array(
			...
			array("\xEF\xBB\xBF", array("j" => 3, "value" => "\xEF\xBB\xBF")), # "byte order mark" 11101111 10111011 10111111 (U+FEFF)
	...
	public function testCodePoints() {
		...
		$this->assertEquals("\xEF\xBB\xBF", Utf8Parser::getBytes(0xFEFF));      # "byte order mark" 11101111 10111011 10111111 (U+FEFF)
